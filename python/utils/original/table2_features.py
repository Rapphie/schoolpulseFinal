...
def build_table2_predictions():
    ...
    # LOAD DATA
    # =========================
    df_demo = pd.read_excel("data/expanded_demographics.xlsx")
    df_att = pd.read_excel("data/expanded_monthly_attendance.xlsx")
    df_scores = pd.read_csv("data/expanded_raw_scores_modified.csv")
