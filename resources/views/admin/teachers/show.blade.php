            ...
            <div class="card shadow mb-4">
                <div class="card-body text-center">
                    @if ($teacher->profile_picture)
                        <img src="{{ asset('storage/' . $teacher->profile_picture) }}" alt="{{ $teacher->name }}"
                    ...
                    <ul class="nav nav-tabs card-header-tabs" id="teacherTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="subjects-tab" data-toggle="tab" href="#subjects" role="tab"
                                aria-controls="subjects" aria-selected="true">
                                Subjects
                            </a>
                        </li>
                        <li class="nav-item">
                                        ...
                                        <tbody>
                                            @foreach ($teacher->subjects as $subject)
                                                <tr>
                                                    ...
                                                    <td>{{ $subject->sections->where('teacher_id', $teacher->id)->count() }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger"><strong>Warning:</strong> This will permanently delete all associated data
                        including classes, grades, and attendance records.</p>
                </div>
