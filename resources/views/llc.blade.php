...
<head>
    ...
    <title>DepEd Competency Item Tracker</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">DepEd Item Tracker</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#tracker-section">Exam Tracker</a>
                    </li>
                    <li class="nav-item">
    ...
    <header class="jumbotron jumbotron-fluid text-center bg-light py-5">
        <div class="container">
            <h1 class="display-4">Exam Item-Level Competency Tracker</h1>
            <p class="lead">Pinpoint specific areas of difficulty based on exam item performance.</p>
        </div>
    </header>

    <main class="container my-5">
        <section id="tracker-section">
            <h2 class="mb-4">Teacher's Exam Item Tracker</h2>
            <div class="card mb-4">
                <div class="card-header bg-success text-white">Define Exam Structure</div>
                <div class="card-body">
                    <form id="examStructureForm">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="examName"
                                    placeholder="e.g., First Quarter English Exam" required>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <label for="studentCount" class="form-label">Total Students Examined:</label>
                                <input type="number" class="form-control" id="studentCount" min="1"
                                    value="30" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-1">
                                        <button type="button" id="addCategoryBtn" class="btn btn-primary w-100"><i
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-success btn-lg" id="startItemInputBtn"
                                disabled>Proceed to Item Input <i class="bi bi-arrow-right-circle-fill"></i></button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <footer class="bg-dark text-white text-center py-4 mt-5">
        <div class="container">
            <p>&copy; 2025 DepEd Competency Item Tracker. All rights reserved.</p>
        </div>
    </footer>
