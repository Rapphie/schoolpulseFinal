                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0"> <a href="{{ route('dashboard') }}">Attendance</a>
                            </h6>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body text-center bg-white-100 radius shadow-2xl">
                            ...
                            <p class="text-bold">
                                @if (isset($subject->schedule) && isset($subject->schedule->section) && isset($subject->schedule->section->students))
                                    {{ $subject->schedule->section->students->count() }}
                                @elseif(isset($subject->students))
                                    {{ $subject->students->count() }}
                                @else
                                    0
                                @endif
                                <i class="fas fa-users-class text-blue"></i>
                            </p>
                            <hr>
                            <div class="text-left">
                                            ...
                                            <tbody class="list">
                                                @if (
                                                    !empty($subject->students) &&
                                                        (is_array($subject->students) || $subject->students instanceof \Illuminate\Support\Collection))
