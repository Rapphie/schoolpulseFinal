...
class PredictionClient
{
    ...
    public function predictBatch(array $batchVectors, ?array $studentIds = null, ?array $studentNames = null): array
    {
        ...
        try {
            ...
            if (! empty($studentIds) && count($studentIds) === count($batchVectors)) {
                $payload['student_ids'] = array_values($studentIds);
            }
